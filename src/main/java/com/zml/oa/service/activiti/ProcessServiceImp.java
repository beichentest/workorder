...
//    	Context.setProcessEngineConfiguration(defaultProcessEngine.getProcessEngineConfiguration());
	 ...
	 * @return
	 */
	public InputStream getDiagramByProInstanceId_flows(String resourceType, String processInstanceId) {
		 //获取历史流程实例
...
//        }
        ...
        //中文显示的是口口口，设置字体就好了
        return diagramGenerator.generateDiagram(bpmnModel, resourceType, highLightedActivitis,highLightedFlows,"宋体","宋体",null,1.0);
	}
...
//        }
	...
	public BaseVO getRunVariable(String processInstanceId) {
		Object object = this.runtimeService.getVariable(processInstanceId, "entity");
