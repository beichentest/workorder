...
public class GroupServiceImpl implements IGroupService {
	...
	@Override
	public List<Group> getGroupListPage(Page<Group> p, String sort, String order) throws Exception {
		List<Group> list = this.baseService.getListPage("Group", new String[]{}, new String[]{}, p,sort,order);
		return list;
	}
