...
//		List<User> list = findByPage("User", new String[]{"group"}, new String[]{groupId});
	...
	@Override
	public List<User> getUserList(Page<User> page, String[] columns, String[] values, String sort, String order)
			throws Exception {
		if(columns==null)
			columns = new String[] {};
		if(values==null)
			values = new String[] {};
		List<User> list = this.getListPage("User", columns, values, page, sort, order);
		return list;
	}
