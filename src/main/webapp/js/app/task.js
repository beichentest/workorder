	...
	todoTask_datagrid = $("#todoTask").datagrid({
		...
		columns : [ 
		    [ 
                ...
                {field : 'owner',title : '负责人',width : fixWidth(0.2),align : 'center',
                	formatter:function(value, row){
    				...
    				button = [
    					 {
				        	  ...
				        	  handler: function () {
				        		  transfer_dialog = $('#task').dialog({
				          			...
				          			cache: false,
				          			modal: true,
				          			href: ctx+"/userAction/toChooseDelegateUserWorkOrder",
				          			buttons: [
				      			          {
				      			        	  text: '确认',
				      			        	  iconCls: 'icon-ok',
    			...
    			buttons: [
			          {
			        	  ...
			        	  handler: function () {			        		  
			        		  ...
			        		  if(userName == ""){
			        			  ...
			        			  $.messager.alert("提示", "不能将此任务委派给自己，请重新选择委派人！"); 
			        			  return false;
			        		  }
