...
$(function() {
    ...
    user_datagrid = $('#user_datagrid').datagrid({
        ...
        columns : [ 
            [ 
              {field : 'name',title : '用户名',width : fixWidth(0.2),align : 'left', editor : {type:'validatebox',options:{required:true}}},
              {field : 'realName',title : '真实姓名',width : fixWidth(0.1),align : 'left', editor : {type:'validatebox',options:{required:true}}},
              {field : 'email',title : '电子邮箱',width : fixWidth(0.2),align : 'left',editor : {type:'validatebox',options:{required:true}}},
              {field : 'mobilePhone',title : '手机',width : fixWidth(0.1),align : 'left',editor : {type:'validatebox',options:{required:true}}},
              {field : 'registerDate', title : '注册时间', width : fixWidth(0.1), editor : "datebox"},
