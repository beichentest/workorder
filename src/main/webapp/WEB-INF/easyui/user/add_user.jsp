...
<div id="dlg" class="easyui-layout" style="padding:10px 20px">
    ...
    <form id="user_form" method="post" >
        ...
        <div class="fitem">
            <label>电子邮箱:</label>
            <input id="email" name="email" class="easyui-textbox easyui-validatebox" required="true">
        </div>
        <div class="fitem">
            <label>手机:</label>
            <input id="mobilePhone" name="mobilePhone" class="easyui-textbox easyui-validatebox" required="true">
        </div>
        <div class="fitem">
            <label>密码:</label>
        ...
        <div class="fitem">
			...
			<input name="group.id"  class="easyui-combotree" id="group" type="text"/>
