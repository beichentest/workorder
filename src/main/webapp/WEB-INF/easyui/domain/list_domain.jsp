...
<html>
  <head>
	...
	<script type="text/javascript" src="${ctx}/js/app/domain.js?_=${sysInitTime}"></script>
  </head>
  <body>
	<div class="well well-small" style="margin-left: 5px;margin-top: 5px">
		<span class="badge">提示</span>
		<p>
			在此你可以对<span class="label-info"><strong>域名</strong></span>进行管理!<br/><br/>
		</p>
	</div>
			...
			<tr>
				<td style="padding-left:2px">
					<%-- <shiro:hasRole name="admin"> --%>
						<a href="javascript:void(0);" class="easyui-linkbutton" iconCls="icon-add" plain="true" onclick="showDomain();">添加</a>
	...
	<table id="domain_datagrid" title="项目管理"></table>
  </body>
</html>
