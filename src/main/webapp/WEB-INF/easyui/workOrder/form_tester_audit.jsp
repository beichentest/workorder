...
<div id="dlg" class="easyui-layout" style="padding:10px 20px">
    <div class="ftitle"><img src="${ctx }/extend/fromedit.png" style="margin-bottom: -3px;"/> 工单申请审核</div>
    <form id="audit_form" method="post" >
		...
		<div class="fitem">
	       <label>项目域名:</label>
	        ...
	        <div class="fitem">
            <label>上线SVN地址:</label>
	            <input id=testSvn name="testSvn" value="${workOrder.testSvn}"  class="easyui-textbox easyui-validatebox" required="true">
	        </div>
	        <div class="fitem">
            <label>上线版本:</label>
