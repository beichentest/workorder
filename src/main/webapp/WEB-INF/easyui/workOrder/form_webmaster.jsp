    ...
    <form id="audit_form" method="post" >
		...
		<div class="fitem">
	       <label>项目域名:</label>
	        ...
	        <div class="fitem">
            <label>上线版本地址:</label>
	            <input id=testSvn name="testSvn" value="${workOrder.testSvn==null?workOrder.project.testerSvn:workOrder.testSvn}"  class="easyui-textbox easyui-validatebox" required="true" readonly="readonly">
	        </div>
	        <div class="fitem">
            <label>上线版本:</label>
