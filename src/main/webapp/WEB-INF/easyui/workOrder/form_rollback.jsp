		...
		<div class="fitem">
	       <label>项目域名:</label>
	        ...
	        <div class="fitem">
	         ...
	         <div class="fitem">
	            <label>测试描述:</label>
	            <input id="test_desc" name="testDesc" value="${workOrder.testDesc}" class="easyui-textbox" required="true" readonly="readonly" data-options="multiline:true" style="height:70px; width: 480px">
	        </div>
	        <div class="fitem">
	            <label>开发人员:</label>	            
	        ...
	        <div class="fitem">
	            <label>回滚原因:</label>
	            <input id="rollbackReason" name="rollbackReason" value="${workOrder.rollbackReason}" class="easyui-textbox"  data-options="multiline:true" style="height:70px; width: 480px">	     
	        </div>
	        <div class="fitem">
	         <label>回滚版本:</label>
	            <input id="rollbackVersion" name="rollbackVersion" value="${workOrder.rollbackVersion}"  class="easyui-textbox easyui-validatebox">
	        </div>
