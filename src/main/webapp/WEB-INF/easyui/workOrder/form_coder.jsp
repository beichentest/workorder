    ...
    <form id="audit_form" method="post" >
		...
		<div class="fitem">
	       <label>项目域名:</label>
	        ...
	        <!--<div class="fitem">
            <label>SVN地址:</label>
	            <input id=coderSvn name="coderSvn" value="${workOrder.coderSvn==null?workOrder.project.coderSvn:workOrder.coderSvn}" class="easyui-textbox easyui-validatebox" required="true" >
	        </div>-->
	        <div class="fitem">
            <label>开发版本:</label>
